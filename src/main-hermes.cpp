...
Adafruit_NeoPixel pixels_1 = Adafruit_NeoPixel(N_PIXELS, PIN_LEDS, NEO_GRBW);
...
{
  pixels_1.begin();
  prop_led_driver.register_strips(&pixels_1, nullptr);
  return true;
}
